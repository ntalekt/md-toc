...
class TestCli(unittest.TestCase):
    ...
    def test_basic_toc_generation(self):
        ...
        result = subprocess.run(["md-toc", temp_filename], capture_output=True, text=True)
    ...
    def test_stdout_output(self):
        ...
        result = subprocess.run(["md-toc", temp_filename, "--stdout"], capture_output=True, text=True)
